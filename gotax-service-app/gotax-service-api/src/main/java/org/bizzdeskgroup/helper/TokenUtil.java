...
//    public static long TOKEN_TTL_MS = 8 * 60 * 60 * 1000; // 8 hours
    public static long TOKEN_TTL_MS = 500 * 60 * 60 * 1000; // 8 hours

    private TokenUtil() {
    }

//    public static String generateTokenString(MPJWTToken jwtContent) throws Exception {
    public static Object generateTokenString(MPJWTToken jwtContent) throws Exception {
